...
First, a big thank you from all of us here at **Snowpeak ** for using our products! Our mission is simple: to build tools that help you do your best work. Millions of people use **Snowpeak ** products every day to help them connect, create, and share. While we may not know every user personally, these terms are a way to ensure everything runs smoothly for everyone. So buckle up, grab your coffee, and let’s dive in!

---

### **What We Mean:**

- **"We", "Our", "Us"** refers to **Snowpeak LLC** (yep, that’s us).
- **"Services"** means our products: websites, apps, and everything else we create, like **Snowpeak **, **HEY**, **Highrise**, **Campfire**, and more (they all fall under the **Snowpeak ** umbrella).
...
1. You are responsible for maintaining the security of your account and password, and for ensuring your users do the same. Snowpeak can’t be held liable for any loss or damage due to a security breach. Pro-tip: Set up [two-factor authentication](#_).
...
**_Disclaimer: Snowpeak shall not be liable for any damages (direct, indirect, or consequential) resulting from the use or inability to use our Services._**
